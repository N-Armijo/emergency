...
SECRET_KEY = 'django-insecure-jw=2qa77of684xv_t8&=1ivf#b0#4u#ds!bj)uyhzl@-2k!v21'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',#desde distinto origen
    'coreapi', #documentacion de la api
    'api'
...
#Sistema de autentificacion por token
REST_FRAMEWORK = {
